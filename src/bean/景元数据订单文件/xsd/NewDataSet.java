...
public class NewDataSet {
    ...
    protected List<SceneDataProcessOrder> processOrder;
     ...
     * {@link SceneDataProcessOrder }
     * 
     * 
     */
    public List<SceneDataProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<SceneDataProcessOrder>();
        }
