...
public class NewDataSet {
    ...
    protected List<OriginDataProcessOrder> processOrder;
     ...
     * {@link OriginDataProcessOrder }
     * 
     * 
     */
    public List<OriginDataProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<OriginDataProcessOrder>();
        }
