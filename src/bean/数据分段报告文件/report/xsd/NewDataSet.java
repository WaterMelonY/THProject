...
public class NewDataSet {
    ...
    protected List<SegmentReportProcessOrder> processOrder;
     ...
     * {@link SegmentReportProcessOrder }
     * 
     * 
     */
    public List<SegmentReportProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<SegmentReportProcessOrder>();
        }
