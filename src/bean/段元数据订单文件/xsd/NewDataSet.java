...
public class NewDataSet {
    ...
    protected List<SegmentDataProcessOrder> processOrder;
     ...
     * {@link SegmentDataProcessOrder }
     * 
     * 
     */
    public List<SegmentDataProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<SegmentDataProcessOrder>();
        }
