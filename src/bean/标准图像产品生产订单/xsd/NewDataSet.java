...
public class NewDataSet {
    ...
    protected List<ProductProcessOrder> processOrder;
     ...
     * {@link ProductProcessOrder }
     * 
     * 
     */
    public List<ProductProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<ProductProcessOrder>();
        }
