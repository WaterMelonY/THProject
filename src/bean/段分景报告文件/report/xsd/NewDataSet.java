...
public class NewDataSet {
    ...
    protected List<SceneReportProcessOrder> processOrder;
     ...
     * {@link SceneReportProcessOrder }
     * 
     * 
     */
    public List<SceneReportProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<SceneReportProcessOrder>();
        }
