...
public class NewDataSet {
    ...
    protected List<SegmentProcessOrder> processOrder;
     ...
     * {@link SegmentProcessOrder }
     * 
     * 
     */
    public List<SegmentProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<SegmentProcessOrder>();
        }
