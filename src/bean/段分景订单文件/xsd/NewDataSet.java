...
public class NewDataSet {
    ...
    protected List<SceneProcessOrder> processOrder;
     ...
     * {@link SceneProcessOrder }
     * 
     * 
     */
    public List<SceneProcessOrder> getProcessOrder() {
        if (processOrder == null) {
            processOrder = new ArrayList<SceneProcessOrder>();
        }
